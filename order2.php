        ...
        <section class="food_section layout_padding">
            <div class="container">
              ...
              <ul class="filters_menu">
                ...
                <li data-filter=".specialpizza">Special Pizza</li>
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
              ...
              <label class="btn btn-secondary" onclick="filterProducts('burger')">
                ...
                <label class="btn btn-secondary active" onclick="filterProducts('specialpizza')">
                  <input type="radio" name="cat" id="specialpizza" autocomplete="off" > Special Pizza
                </label>
      ...
      if (category === 'pizza') {
        ...
        addOnsHTML += `
          ...
          <table class="table table-striped"> 
            <tbody>
                <tr>
                    <td><label for="addon1"> Pepperoni </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon1" value="Pepperoni" data-price="0.00" name="addon"> </td>
                </tr>
                <tr>
                    <td><label for="addon1"> Chicken </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Chicken" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Ground Beef </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Ground Beef" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Black Olives </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Black Olives" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Green Olives </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Green Olives" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Feta Cheese </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Feta Cheese" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Hot Peppers </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Hot Peppers" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Red Peppers </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Red Peppers" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Green Peppers </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Green Peppers" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Jalapeno </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Jalapeno" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Fresh Garlic </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Fresh Garlic" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Tomato </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Tomato" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Sun-Dried </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Sun-Dried" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Spinach </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Spinach" data-price="0.00" name="addon"></td>
                </tr>
                <tr>
                    <td><label for="addon1"> Mushroom </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="Mushroom" data-price="0.00" name="addon"></td>
                </tr>
            </tbody>
          </table>
          ...
          <table class="table "> 
            <tbody>
                ...
                <tr>
                    <td><label for="addon1"> Pop - ($2.50) </label></td>
                    <td><input type="checkbox" class="form-check-input addon-checkbox" id="addon2" value="pop" data-price="2.50"> </td>
                </tr>
            </tbody>
          </table>
        ...
        <div class="footer-box pad-top-70">
            ...
            <div class="container">
                ...
                <div>
                  ...
                  <?php
                    ...
                    if(isset($_POST['send'])) {
                      ...
                      if ($run) {
                        echo "<script>alert('Your message has successfully send. Thank You!')</script>";
                      } else {
                        echo "<script>alert('This message cannot be send. Try again.')</script>";
                      }
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2885.107956378865!2d-79.49641721578733!3d43.6875189757098!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b37d039b6ef7d%3A0xeca38ab0bb142e84!2sYork%20Burger%20%26%20Pizza%20(Halal)!5e0!3m2!1sen!2sbd!4v1709116848081!5m2!1sen!2sbd"  frameborder="0" style="border:0;padding-top:20px; width: 100%; height: 300px;" allowfullscreen></iframe>
                </div>
            </div>
